...
export class Backend implements backendInterface {
    ...
    async getNFT(arg0: bigint): Promise<NFT> {
        if (this.processError) {
            try {
    ...
    async getNFTsByMinter(): Promise<Array<NFT>> {
        if (this.processError) {
            try {
                const result = await this.actor.getNFTsByMinter();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getNFTsByOwner(): Promise<Array<NFT>> {
        if (this.processError) {
            try {
                const result = await this.actor.getNFTsByOwner();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async mintNFT(arg0: string, arg1: string, arg2: string): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.mintNFT(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
